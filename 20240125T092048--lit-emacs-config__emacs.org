...
#+begin_src emacs-lisp :tangle ~/.emacs.d/keybind.el
  ;; b for buffer---------------------------------------------------------------------
  ...
  ;; make-org-heading
  (define-key global-map (kbd "C-c h") 'make-org-heading)
...
** meow.el
#+begin_src emacs-lisp :tangle "~/.emacs.d/meow.el"
  (defun meow-setup ()
...
#+begin_src emacs-lisp
  (use-package denote
              :custom (denote-directory "~/org-roam/denote/")
